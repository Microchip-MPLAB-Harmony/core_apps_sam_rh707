...
{"0": {
    ...
    "url": "http://localhost:4000/core_apps_sam_rh707/mplab_harmony_license.html",
    ...
    "url": "http://localhost:4000/core_apps_sam_rh707/apps/driver/i2c/sync/i2c_eeprom/readme.html#i2c-driver-synchronous---i2c-eeprom",
    "relUrl": "/apps/driver/i2c/sync/i2c_eeprom/readme.html#i2c-driver-synchronous---i2c-eeprom"
  },"2": {
    "doc": "I2C driver synchronous - I2C EEPROM",
    "title": "Description",
    "content": "This example uses the I2C driver in synchronous mode to communicate with the EEPROM to perform write and read operations in RTOS environment. This application uses I2C driver to read and write data from an external EEPROM memory chip. ",
    "url": "http://localhost:4000/core_apps_sam_rh707/apps/driver/i2c/sync/i2c_eeprom/readme.html#description",
    "relUrl": "/apps/driver/i2c/sync/i2c_eeprom/readme.html#description"
  },"3": {
    "doc": "I2C driver synchronous - I2C EEPROM",
    "title": "Downloading and building the application",
    "content": "To clone or download this application from Github, go to the main page of this repository and then click Clone button to clone this repository or download as zip file. This content can also be downloaded using content manager by following these instructions. Path of the application within the repository is apps/driver/i2c/sync/i2c_eeprom/firmware . To build the application, refer to the following table and open the project using its IDE. | Project Name | Description | . | sam_rh707_ek_freertos.X | MPLABX project for SAM RH707 Evaluation Kit | . |   |   | . ",
    "url": "http://localhost:4000/core_apps_sam_rh707/apps/driver/i2c/sync/i2c_eeprom/readme.html#downloading-and-building-the-application",
    "relUrl": "/apps/driver/i2c/sync/i2c_eeprom/readme.html#downloading-and-building-the-application"
  },"4": {
    "doc": "I2C driver synchronous - I2C EEPROM",
    "title": "Setting up the hardware",
    "content": "The following table shows the target hardware for the application projects. | Project Name | Board | . | sam_rh707_ek_freertos.X | SAM RH707 Evaluation Kit | . |   |   | . Setting up SAM RH707 Evaluation Kit . | To run the demo, the following additional hardware are required: . | One EEPROM 3 Click board | One mikroBUS Xplained Pro boards | . | Connect mikroBUS Xplained Pro board to J18 header | Plug the EEPROM 3 click Board into the MikroBus socket of the mikroBUS Xplained Pro board | Connect the debugger probe to J5 connector | Connect the J1 (USB-C) port on the board to the computer using a USB-C cable | . ",
    "url": "http://localhost:4000/core_apps_sam_rh707/apps/driver/i2c/sync/i2c_eeprom/readme.html#setting-up-the-hardware",
    "relUrl": "/apps/driver/i2c/sync/i2c_eeprom/readme.html#setting-up-the-hardware"
  },"5": {
    "doc": "I2C driver synchronous - I2C EEPROM",
    "title": "Running the Application",
    "content": ". | Build and program the application using its IDE | LED indicates success or failure: . | The LED is turned ON when the value read from the EEPROM matched with the written value | . | . Refer to the following table for LED name: . | Board | LED Name | . | SAM RH707 Evaluation Kit | LED0 | . |   |   | . ",
    "url": "http://localhost:4000/core_apps_sam_rh707/apps/driver/i2c/sync/i2c_eeprom/readme.html#running-the-application",
    "relUrl": "/apps/driver/i2c/sync/i2c_eeprom/readme.html#running-the-application"
  },"6": {
    "doc": "I2C driver synchronous - I2C EEPROM",
    "title": "I2C driver synchronous - I2C EEPROM",
    "content": ". ",
    "url": "http://localhost:4000/core_apps_sam_rh707/apps/driver/i2c/sync/i2c_eeprom/readme.html",
    ...
    "url": "http://localhost:4000/core_apps_sam_rh707/apps/driver/spi/async/spi_self_loopback_multi_client/readme.html#spi-driver-asynchronous---self-loopback-multi-client",
    ...
    "url": "http://localhost:4000/core_apps_sam_rh707/apps/driver/spi/async/spi_self_loopback_multi_client/readme.html#description",
    ...
    "url": "http://localhost:4000/core_apps_sam_rh707/apps/driver/spi/async/spi_self_loopback_multi_client/readme.html#downloading-and-building-the-application",
    "relUrl": "/apps/driver/spi/async/spi_self_loopback_multi_client/readme.html#downloading-and-building-the-application"
  },"10": {
    "doc": "SPI Driver asynchronous - Self loopback multi client",
    "title": "Setting up the hardware",
    "content": "The following table shows the target hardware for the application projects. | Project Name | Board | . | sam_rh707_ek.X | SAM RH707 Evaluation Kit | . |   |   | . Setting up SAM RH707 Evaluation Kit . | Use jumper wire to Connect “Pin 16 of J18 header” to “Pin 17 of J18 header” . | FLEXCOM3_IO0 signal as MOSI signal and it is mapped to PB22 that is routed to “Pin 16 of J18 header” | FLEXCOM3_IO1 signal as MISO signal and it is mapped to PB21 that is routed to “Pin 17 of J18 header” | . | Connect the debugger probe to J5 connector | Connect the J1 (USB-C) port on the board to the computer using a USB-C cable | . ",
    "url": "http://localhost:4000/core_apps_sam_rh707/apps/driver/spi/async/spi_self_loopback_multi_client/readme.html#setting-up-the-hardware",
    "relUrl": "/apps/driver/spi/async/spi_self_loopback_multi_client/readme.html#setting-up-the-hardware"
  },"11": {
    "doc": "SPI Driver asynchronous - Self loopback multi client",
    "title": "Running the Application",
    "content": ". | Build and program the application using its IDE | The LED is turned ON on Success | . Refer to the following table for LED name: . | Board | LED Name | . | SAM RH707 Evaluation Kit | LED0 | . |   |   | . ",
    "url": "http://localhost:4000/core_apps_sam_rh707/apps/driver/spi/async/spi_self_loopback_multi_client/readme.html#running-the-application",
    "relUrl": "/apps/driver/spi/async/spi_self_loopback_multi_client/readme.html#running-the-application"
  },"12": {
    "doc": "SPI Driver asynchronous - Self loopback multi client",
    "title": "SPI Driver asynchronous - Self loopback multi client",
    "content": ". ",
    "url": "http://localhost:4000/core_apps_sam_rh707/apps/driver/spi/async/spi_self_loopback_multi_client/readme.html",
    ...
    "url": "http://localhost:4000/core_apps_sam_rh707/apps/driver/spi/sync/spi_self_loopback_multi_client/readme.html#spi-driver-synchronous---self-loopback-multi-client",
    ...
    "url": "http://localhost:4000/core_apps_sam_rh707/apps/driver/spi/sync/spi_self_loopback_multi_client/readme.html#description",
    ...
    "url": "http://localhost:4000/core_apps_sam_rh707/apps/driver/spi/sync/spi_self_loopback_multi_client/readme.html#downloading-and-building-the-application",
    "relUrl": "/apps/driver/spi/sync/spi_self_loopback_multi_client/readme.html#downloading-and-building-the-application"
  },"16": {
    "doc": "SPI Driver synchronous - Self loopback multi client",
    "title": "Setting up the hardware",
    "content": "The following table shows the target hardware for the application projects. | Project Name | Board | . | sam_rh707_ek_freertos.X | SAM RH707 Evaluation Kit | . |   |   | . Setting up SAM RH707 Evaluation Kit . | Use jumper wire to Connect “Pin 16 of J18 header” to “Pin 17 of J18 header” . | FLEXCOM3_IO0 signal as MOSI signal and it is mapped to PB22 that is routed to “Pin 16 of J18 header” | FLEXCOM3_IO1 signal as MISO signal and it is mapped to PB21 that is routed to “Pin 17 of J18 header” | . | Connect the debugger probe to J5 connector | Connect the J1 (USB-C) port on the board to the computer using a USB-C cable | . ",
    "url": "http://localhost:4000/core_apps_sam_rh707/apps/driver/spi/sync/spi_self_loopback_multi_client/readme.html#setting-up-the-hardware",
    "relUrl": "/apps/driver/spi/sync/spi_self_loopback_multi_client/readme.html#setting-up-the-hardware"
  },"17": {
    "doc": "SPI Driver synchronous - Self loopback multi client",
    "title": "Running the Application",
    "content": ". | Build and program the application using its IDE | The LED is turned ON on Success | . Refer to the following table for LED name: . | Board | LED Name | . | SAM RH707 Evaluation Kit | LED0 | . |   |   | . ",
    "url": "http://localhost:4000/core_apps_sam_rh707/apps/driver/spi/sync/spi_self_loopback_multi_client/readme.html#running-the-application",
    "relUrl": "/apps/driver/spi/sync/spi_self_loopback_multi_client/readme.html#running-the-application"
  },"18": {
    "doc": "SPI Driver synchronous - Self loopback multi client",
    "title": "SPI Driver synchronous - Self loopback multi client",
    "content": ". ",
    "url": "http://localhost:4000/core_apps_sam_rh707/apps/driver/spi/sync/spi_self_loopback_multi_client/readme.html",
    ...
    "url": "http://localhost:4000/core_apps_sam_rh707/apps/driver/usart/async/usart_echo/readme.html#usart-driver-asynchronous---uart-echo",
    ...
    "url": "http://localhost:4000/core_apps_sam_rh707/apps/driver/usart/async/usart_echo/readme.html#description",
    ...
    "url": "http://localhost:4000/core_apps_sam_rh707/apps/driver/usart/async/usart_echo/readme.html#downloading-and-building-the-application",
    ...
    "url": "http://localhost:4000/core_apps_sam_rh707/apps/driver/usart/async/usart_echo/readme.html#setting-up-the-hardware",
    "relUrl": "/apps/driver/usart/async/usart_echo/readme.html#setting-up-the-hardware"
  },"23": {
    "doc": "USART driver asynchronous - UART echo",
    "title": "Running the Application",
    "content": ". | Open the Terminal application (Ex.:Tera term) on the computer | Connect to the USB to UART COM port and configure the serial settings as follows: . | Baud : 115200 | Data : 8 Bits | Parity : None | Stop : 1 Bit | Flow Control : None | . | Build and Program the application using its IDE | Type a character and observe the output on the console as shown below: . | LED toggles each time the character is echoed | . Refer to the following table for LED name: . | Board | LED Name | . | SAM RH707 Evaluation Kit | LED0 | . |   |   | . ",
    "url": "http://localhost:4000/core_apps_sam_rh707/apps/driver/usart/async/usart_echo/readme.html#running-the-application",
    "relUrl": "/apps/driver/usart/async/usart_echo/readme.html#running-the-application"
  },"24": {
    "doc": "USART driver asynchronous - UART echo",
    "title": "USART driver asynchronous - UART echo",
    "content": ". ",
    "url": "http://localhost:4000/core_apps_sam_rh707/apps/driver/usart/async/usart_echo/readme.html",
    ...
    "url": "http://localhost:4000/core_apps_sam_rh707/apps/driver/usart/sync/usart_echo/readme.html#usart-driver-synchronous---uart-echo",
    ...
    "url": "http://localhost:4000/core_apps_sam_rh707/apps/driver/usart/sync/usart_echo/readme.html#description",
    ...
    "url": "http://localhost:4000/core_apps_sam_rh707/apps/driver/usart/sync/usart_echo/readme.html#downloading-and-building-the-application",
    "relUrl": "/apps/driver/usart/sync/usart_echo/readme.html#downloading-and-building-the-application"
  },"28": {
    "doc": "USART driver synchronous - UART echo",
    "title": "Setting up the hardware",
    "content": "The following table shows the target hardware for the application projects. | Project Name | Board | . | sam_rh707_ek_freertos.X | SAM RH707 Evaluation Kit | . |   |   | . Setting up SAM RH707 Evaluation Kit . | Connect the Debug USB port on the board to the computer using a micro USB cable | Connect the debugger probe to J5 connector | Connect the J1 (USB-C) port on the board to the computer using a USB-C cable | . ",
    "url": "http://localhost:4000/core_apps_sam_rh707/apps/driver/usart/sync/usart_echo/readme.html#setting-up-the-hardware",
    "relUrl": "/apps/driver/usart/sync/usart_echo/readme.html#setting-up-the-hardware"
  },"29": {
    "doc": "USART driver synchronous - UART echo",
    "title": "Running the Application",
    "content": ". | Open the Terminal application (Ex.:Tera term) on the computer | Connect to the USB to UART COM port and configure the serial settings as follows: . | Baud : 115200 | Data : 8 Bits | Parity : None | Stop : 1 Bit | Flow Control : None | . | Build and Program the application using its IDE | Type a character and observe the output on the console as shown below: . | LED toggles each time the character is echoed | . Refer to the following table for LED name: . | Board | LED Name | . | SAM RH707 Evaluation Kit | LED0 | . |   |   | . ",
    "url": "http://localhost:4000/core_apps_sam_rh707/apps/driver/usart/sync/usart_echo/readme.html#running-the-application",
    "relUrl": "/apps/driver/usart/sync/usart_echo/readme.html#running-the-application"
  },"30": {
    "doc": "USART driver synchronous - UART echo",
    "title": "USART driver synchronous - UART echo",
    "content": ". ",
    "url": "http://localhost:4000/core_apps_sam_rh707/apps/driver/usart/sync/usart_echo/readme.html",
    ...
    "url": "http://localhost:4000/core_apps_sam_rh707/apps/fs/nvm_fat/readme.html#fat-filesystem-using-nvm-media",
    ...
    "url": "http://localhost:4000/core_apps_sam_rh707/apps/fs/nvm_fat/readme.html#description",
    ...
    "url": "http://localhost:4000/core_apps_sam_rh707/apps/fs/nvm_fat/readme.html#downloading-and-building-the-application",
    ...
    "url": "http://localhost:4000/core_apps_sam_rh707/apps/fs/nvm_fat/readme.html#setting-up-the-hardware",
    "relUrl": "/apps/fs/nvm_fat/readme.html#setting-up-the-hardware"
  },"35": {
    "doc": "FAT filesystem using NVM Media",
    "title": "Running the Application",
    "content": ". | Build and program the application using its IDE | Press Switch to start the file operations | The LED is turned ON when the File FILE.TXT has the app data “Hello World” written in it | . Refer to the following table for switch and LED name: . | Board | Switch name | LED Name | . | SAM RH707 Evaluation Kit | PB0 | LED1 | . |   |   |   | . ",
    "url": "http://localhost:4000/core_apps_sam_rh707/apps/fs/nvm_fat/readme.html#running-the-application",
    "relUrl": "/apps/fs/nvm_fat/readme.html#running-the-application"
  },"36": {
    "doc": "FAT filesystem using NVM Media",
    "title": "FAT filesystem using NVM Media",
    "content": ". ",
    "url": "http://localhost:4000/core_apps_sam_rh707/apps/fs/nvm_fat/readme.html",
    ...
    "url": "http://localhost:4000/core_apps_sam_rh707/apps/fs/sdspi_fat/readme.html#fat-filesystem-using-sdspi-media",
    ...
    "url": "http://localhost:4000/core_apps_sam_rh707/apps/fs/sdspi_fat/readme.html#description",
    ...
    "url": "http://localhost:4000/core_apps_sam_rh707/apps/fs/sdspi_fat/readme.html#downloading-and-building-the-application",
    "relUrl": "/apps/fs/sdspi_fat/readme.html#downloading-and-building-the-application"
  },"40": {
    "doc": "FAT filesystem using SDSPI Media",
    "title": "Setting up the hardware",
    "content": "The following table shows the target hardware for the application projects. | Project Name | Board | . | sam_rh707_ek.X | SAM RH707 Evaluation Kit | . |   |   | . Setting up SAM RH707 Evaluation Kit . | To run the demo, the following additional hardware are required: . | One IO1 Xplained Pro Extension Kit | One micro-sd card | . | Connect IO1 Xplained Pro Extension Kit to the J18 connector | Insert the micro-SD Card in the micro-SD Card slot of the IO1 Xplained Pro Extension Kit | Connect the debugger probe to J5 connector | Connect the J1 (USB-C) port on the board to the computer using a USB-C cable | . ",
    "url": "http://localhost:4000/core_apps_sam_rh707/apps/fs/sdspi_fat/readme.html#setting-up-the-hardware",
    "relUrl": "/apps/fs/sdspi_fat/readme.html#setting-up-the-hardware"
  },"41": {
    "doc": "FAT filesystem using SDSPI Media",
    "title": "Running the Application",
    "content": ". | Build and program the application using its IDE | Press Switch to start the file operations | The LED is turned ON if there was no error during creating the directory and copying the file into it | . Refer to the following table for switch and LED name: . | Board | Switch name | LED Name | . | SAM RH707 Evaluation Kit | PB0 | LED0 | . |   |   |   | . | If LED is ON, Insert the SD Card on to your host PC | SD Card should have the file Dir1/FILE_TOO_LONG_NAME_EXAMPLE_123.JPG and should match the original image | . ",
    "url": "http://localhost:4000/core_apps_sam_rh707/apps/fs/sdspi_fat/readme.html#running-the-application",
    "relUrl": "/apps/fs/sdspi_fat/readme.html#running-the-application"
  },"42": {
    "doc": "FAT filesystem using SDSPI Media",
    "title": "FAT filesystem using SDSPI Media",
    "content": ". ",
    "url": "http://localhost:4000/core_apps_sam_rh707/apps/fs/sdspi_fat/readme.html",
    ...
    "url": "http://localhost:4000/core_apps_sam_rh707/apps/rtos/freertos/basic_freertos/readme.html#freertos-basic",
    ...
    "url": "http://localhost:4000/core_apps_sam_rh707/apps/rtos/freertos/basic_freertos/readme.html#description",
    ...
    "url": "http://localhost:4000/core_apps_sam_rh707/apps/rtos/freertos/basic_freertos/readme.html#downloading-and-building-the-application",
    "relUrl": "/apps/rtos/freertos/basic_freertos/readme.html#downloading-and-building-the-application"
  },"46": {
    "doc": "FreeRTOS basic",
    "title": "Setting up the hardware",
    "content": "The following table shows the target hardware for the application projects. | Project Name | Board | . | sam_rh707_ek.X | SAM RH707 Evaluation Kit | . |   |   | . Setting up SAM RH707 Evaluation Kit . | Connect the Debug USB port on the board to the computer using a micro USB cable | Connect the debugger probe to J5 connector | Connect the J1 (USB-C) port on the board to the computer using a USB-C cable | . ",
    "url": "http://localhost:4000/core_apps_sam_rh707/apps/rtos/freertos/basic_freertos/readme.html#setting-up-the-hardware",
    "relUrl": "/apps/rtos/freertos/basic_freertos/readme.html#setting-up-the-hardware"
  },"47": {
    "doc": "FreeRTOS basic",
    "title": "Running the Application",
    "content": ". | Open the Terminal application (Ex.:Tera Term) on the computer. | Connect to the USB to UART COM port and configure the serial settings as follows: . Baud : 115200 . Data : 8 Bits . Parity : None . Stop : 1 Bit . Flow Control : None . | Build and program the application using its IDE. | Observe the following output on the terminal. | Enter any character on the terminal to run task3. Notice how task1 and task2 are pre-empted by task3 as task3 is of higher priority than task1 and task2. Pressing character ‘l’ or “L’ toggles the on board LED. Notice how task1 and task2 are not run when characters are entered continuously on the terminal. | Press the user switch on the board to run task4. Notice how task4 preempts all other tasks as it is of highest priority. | . | Board | LED Name | Switch Name | . | [SAM RH707 Evaluation Kit](https://www.microchip.com/en-us/development-tool/SAMRH707F18-EK) | LED1 | PB0 | . |   |   |   | . ",
    "url": "http://localhost:4000/core_apps_sam_rh707/apps/rtos/freertos/basic_freertos/readme.html#running-the-application",
    "relUrl": "/apps/rtos/freertos/basic_freertos/readme.html#running-the-application"
  },"48": {
    "doc": "FreeRTOS basic",
    "title": "FreeRTOS basic",
    "content": ". ",
    "url": "http://localhost:4000/core_apps_sam_rh707/apps/rtos/freertos/basic_freertos/readme.html",
    ...
    "url": "http://localhost:4000/core_apps_sam_rh707/apps/system/time/sys_time_multiclient/readme.html#time-system-service-multi-client",
    ...
    "url": "http://localhost:4000/core_apps_sam_rh707/apps/system/time/sys_time_multiclient/readme.html#description",
    ...
    "url": "http://localhost:4000/core_apps_sam_rh707/apps/driver/i2c/async/i2c_eeprom/readme.html#i2c-driver-asynchronous---i2c-eeprom",
    "relUrl": "/apps/driver/i2c/async/i2c_eeprom/readme.html#i2c-driver-asynchronous---i2c-eeprom"
  },"56": {
    "doc": "I2C driver asynchronous - I2C EEPROM",
    "title": "Description",
    "content": "This example uses the I2C driver in asynchronous mode to communicate with the EEPROM to perform write and read operations in Bare-Metal environment. This application uses I2C driver to read and write data from an external EEPROM memory chip. ",
    "url": "http://localhost:4000/core_apps_sam_rh707/apps/driver/i2c/async/i2c_eeprom/readme.html#description",
    ...
    "url": "http://localhost:4000/core_apps_sam_rh707/apps/driver/i2c/async/i2c_eeprom/readme.html#downloading-and-building-the-application",
    "relUrl": "/apps/driver/i2c/async/i2c_eeprom/readme.html#downloading-and-building-the-application"
  },"58": {
    "doc": "I2C driver asynchronous - I2C EEPROM",
    "title": "Setting up the hardware",
    "content": "The following table shows the target hardware for the application projects. | Project Name | Board | . | sam_rh707_ek.X | SAM RH707 Evaluation Kit | . |   |   | . Setting up SAM RH707 Evaluation Kit . | To run the demo, the following additional hardware are required: . | One EEPROM 3 Click board | One mikroBUS Xplained Pro boards | . | Connect mikroBUS Xplained Pro board to J18 header | Plug the EEPROM 3 click Board into the MikroBus socket of the mikroBUS Xplained Pro board | Connect the debugger probe to J5 connector | Connect the J1 (USB-C) port on the board to the computer using a USB-C cable | . ",
    "url": "http://localhost:4000/core_apps_sam_rh707/apps/driver/i2c/async/i2c_eeprom/readme.html#setting-up-the-hardware",
    "relUrl": "/apps/driver/i2c/async/i2c_eeprom/readme.html#setting-up-the-hardware"
  },"59": {
    "doc": "I2C driver asynchronous - I2C EEPROM",
    "title": "Running the Application",
    "content": ". | Build and program the application using its IDE | LED indicates success or failure: . | The LED is turned ON when the value read from the EEPROM matched with the written value | . | . Refer to the following table for LED name: . | Board | LED Name | . | SAM RH707 Evaluation Kit | LED0 | . |   |   | . ",
    "url": "http://localhost:4000/core_apps_sam_rh707/apps/driver/i2c/async/i2c_eeprom/readme.html#running-the-application",
    "relUrl": "/apps/driver/i2c/async/i2c_eeprom/readme.html#running-the-application"
  },"60": {
    "doc": "I2C driver asynchronous - I2C EEPROM",
    "title": "I2C driver asynchronous - I2C EEPROM",
    "content": ". ",
    "url": "http://localhost:4000/core_apps_sam_rh707/apps/driver/i2c/async/i2c_eeprom/readme.html",
    "relUrl": "/apps/driver/i2c/async/i2c_eeprom/readme.html"
  },"61": {
    "doc": "Release notes",
    "title": "Release notes",
    "content": "![Microchip logo](https://raw.githubusercontent.com/wiki/Microchip-MPLAB-Harmony/Microchip-MPLAB-Harmony.github.io/images/microchip_logo.png) ![Harmony logo small](https://raw.githubusercontent.com/wiki/Microchip-MPLAB-Harmony/Microchip-MPLAB-Harmony.github.io/images/microchip_mplab_harmony_logo_small.png) # Microchip MPLAB® Harmony 3 Release Notes ## Harmony 3 peripheral library application examples for SAM RH707 family v3.1.0 ### Development kit and demo application support Following table provides number of peripheral library examples available for different development kits. | Development Kits | MPLAB X applications |:-----------------:|:-------------------:| [SAMRH707F18 Evaluation Kit](https://www.microchip.com/en-us/development-tool/SAMRH707F18-EK) | 10 | ### New Features - None ### Known Issues - None ### Development Tools - [MPLAB® X IDE v6.05](https://www.microchip.com/mplab/mplab-x-ide) - MPLAB® X IDE plug-ins: - MPLAB® Code Configurator (MCC) v5.3.0 - [MPLAB® XC32 C/C++ Compiler v4.21](https://www.microchip.com/mplab/compilers) ## Harmony 3 driver and system service application examples for SAM RH707 family v3.0.0 ### Development kit and demo application support Following table provides number of peripheral library examples available for different development kits. | Development Kits | MPLAB X applications |:-----------------:|:-------------------:| [SAMRH707F18 Evaluation Kit](https://www.microchip.com/en-us/development-tool/SAMRH707F18-EK) | 10 | ### New Features - None ### Known Issues - None ### Development Tools - [MPLAB® X IDE v6.00](https://www.microchip.com/mplab/mplab-x-ide) - MPLAB® X IDE plug-ins: - MPLAB® Code Configurator (MCC) v5.1.9 - [MPLAB® XC32 C/C++ Compiler v4.10](https://www.microchip.com/mplab/compilers) ",
    "url": "http://localhost:4000/core_apps_sam_rh707/release_notes.html",
    "relUrl": "/release_notes.html"
  },"62": {
    "doc": "Harmony 3 driver and system service application examples for SAM RH707 family",
    "title": "Harmony 3 driver and system service application examples for SAM RH707 family",
    "content": "[![MCHP](https://www.microchip.com/ResourcePackages/Microchip/assets/dist/images/logo.png)](https://www.microchip.com) # Harmony 3 driver and system service application examples for SAM RH707 family MPLAB® Harmony 3 is an extension of the MPLAB® ecosystem for creating embedded firmware solutions for Microchip 32-bit SAM and PIC® microcontroller and microprocessor devices. Refer to the following links for more information. - [Microchip 32-bit MCUs](https://www.microchip.com/design-centers/32-bit) - [Microchip 32-bit MPUs](https://www.microchip.com/design-centers/32-bit-mpus) - [Microchip MPLAB X IDE](https://www.microchip.com/mplab/mplab-x-ide) - [Microchip MPLAB® Harmony](https://www.microchip.com/mplab/mplab-harmony) - [Microchip MPLAB® Harmony Pages](https://microchip-mplab-harmony.github.io/) This repository contains the MPLAB® Harmony 3 driver and system service application examples for SAM RH707 family - [Release Notes](/core_apps_sam_rh707/release_notes.html) - [MPLAB® Harmony License](/core_apps_sam_rh707/mplab_harmony_license.html) To clone or download these applications from Github, go to the [main page of this repository](https://github.com/Microchip-MPLAB-Harmony/core_apps_sam_rh707) and then click **Clone** button to clone this repository or download as zip file. This content can also be downloaded using content manager by following these [instructions](https://github.com/Microchip-MPLAB-Harmony/contentmanager/wiki). ## Contents Summary | Folder | Description | --- | --- | apps | Contains driver and system service example applications | docs | Contains documentation in html format for offline viewing (to be used only after cloning this repository onto a local machine). Use [github pages](https://microchip-mplab-harmony.github.io/core_apps_sam_rh707/) of this repository for viewing it online. | ## Code Examples The following applications are provided to demonstrate the typical or interesting usage models of one or more peripheral libraries. | Name | Description | ---- | ----------- | [I2C driver asynchronous - I2C EEPROM](/core_apps_sam_rh707/apps/driver/i2c/async/i2c_eeprom/readme.html) | This example application shows how to use the I2C driver in asynchronous mode to perform operations on the EEPROM | [I2C driver synchronous - I2C EEPROM](/core_apps_sam_rh707/apps/driver/i2c/sync/i2c_eeprom/readme.html) | This example application shows how to use the I2C driver in synchronous mode to perform operations on the EEPROM | [SPI Driver asynchronous - Self loopback multi client](/core_apps_sam_rh707/apps/driver/spi/async/spi_self_loopback_multi_client/readme.html) | This example demonstrates how to use the SPI driver in asynchronous mode to achieve self-loop back between multiple clients | [SPI Driver synchronous - Self loopback multi client](/core_apps_sam_rh707/apps/driver/spi/sync/spi_self_loopback_multi_client/readme.html) | This example demonstrates how to use the SPI driver in synchronous mode to achieve self-loop back between multiple clients in RTOS environment | [USART driver asynchronous - UART echo](/core_apps_sam_rh707/apps/driver/usart/async/usart_echo/readme.html) | This example echoes the received characters over the console using the USART driver in asynchronous mode | [USART driver synchronous - UART echo](/core_apps_sam_rh707/apps/driver/usart/sync/usart_echo/readme.html) | This example echoes the received characters over the console using the USART driver in synchronous mode | [FAT filesystem using NVM Media](/core_apps_sam_rh707/apps/fs/nvm_fat/readme.html) | This application shows an example of implementing a FAT disk in the device internal Flash memory | [FAT filesystem using SDSPI Media](/core_apps_sam_rh707/apps/fs/sdspi_fat/readme.html) | This application shows an example of using the MPLAB Harmony File System to access and modify the contents of a SD card using the SDSPI driver and the SPI PLIB | [FreeRTOS basic](/core_apps_sam_rh707/apps/rtos/freertos/basic_freertos/readme.html) | This example application demonstrates context switching between four tasks of different priorites. Two tasks run periodically while the other two tasks are event driven | [Time System Service multi-client](/core_apps_sam_rh707/apps/system/time/sys_time_multiclient/readme.html) | This example application demonstrates the multi-client system timer functionality | ____ [![License](https://img.shields.io/badge/license-Harmony%20license-orange.svg)](https://github.com/Microchip-MPLAB-Harmony/core_apps_sam_rh707/blob/master/mplab_harmony_license.md) [![Latest release](https://img.shields.io/github/release/Microchip-MPLAB-Harmony/core_apps_sam_rh707.svg)](https://github.com/Microchip-MPLAB-Harmony/core_apps_sam_rh707/releases/latest) [![Latest release date](https://img.shields.io/github/release-date/Microchip-MPLAB-Harmony/core_apps_sam_rh707.svg)](https://github.com/Microchip-MPLAB-Harmony/core_apps_sam_rh707/releases/latest) [![Commit activity](https://img.shields.io/github/commit-activity/y/Microchip-MPLAB-Harmony/core_apps_sam_rh707.svg)](https://github.com/Microchip-MPLAB-Harmony/core_apps_sam_rh707/graphs/commit-activity) [![Contributors](https://img.shields.io/github/contributors-anon/Microchip-MPLAB-Harmony/core_apps_sam_rh707.svg)]() ____ [![Follow us on Youtube](https://img.shields.io/badge/Youtube-Follow%20us%20on%20Youtube-red.svg)](https://www.youtube.com/user/MicrochipTechnology) [![Follow us on LinkedIn](https://img.shields.io/badge/LinkedIn-Follow%20us%20on%20LinkedIn-blue.svg)](https://www.linkedin.com/company/microchip-technology) [![Follow us on Facebook](https://img.shields.io/badge/Facebook-Follow%20us%20on%20Facebook-blue.svg)](https://www.facebook.com/microchiptechnology/) [![Follow us on Twitter](https://img.shields.io/twitter/follow/MicrochipTech.svg?style=social)](https://twitter.com/MicrochipTech) [![](https://img.shields.io/github/stars/Microchip-MPLAB-Harmony/core_apps_sam_rh707.svg?style=social)]() [![](https://img.shields.io/github/watchers/Microchip-MPLAB-Harmony/core_apps_sam_rh707.svg?style=social)]() ",
    "url": "http://localhost:4000/core_apps_sam_rh707/",
    "relUrl": "/"
  }
}
`;
...
var repo_name = "core_apps_sam_rh707";
var doc_folder_name = "docs";
var localhost_path = "http://localhost:4000/";
var home_index_string = "Harmony 3 driver and system service application examples for SAM RH707 family";
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', 'http://localhost:4000/core_apps_sam_rh707/assets/css/just-the-docs-' + theme + '.css');
}
